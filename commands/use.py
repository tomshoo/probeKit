        ...
        if len(module) > 1:
            ...
            if module[0] in _modules:
                if module[0] not in self.ReturnStruct.activated_module_list:
                    ...
                    curridx: int = self.ReturnStruct.activated_module_list.index(
                        module[0]
                    )
                    self.ReturnStruct.activated_module_list.append(
                        self.ReturnStruct.activated_module_list.pop(curridx)
                    )
